...
exports.createUsageConsumptionReportRequest = function(req, res, next) {
  /**
   * Creates a UsageConsumptionReportRequest
   * This operation creates a UsageConsumptionReportRequest entity.
   *
   * usageConsumptionReportRequest UsageConsumptionReportRequest_Create The UsageConsumptionReportRequest to be created
   * returns UsageConsumptionReportRequest
   **/

  console.log('createUsageConsumptionReportRequest :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);

  /* matching isRestfulCreate - argument usageConsumptionReportRequest */
  
  const resourceType = getResponseType(req);
  const requestSchema = getPayloadSchema(req);

  swaggerUtils.getPayload(req)
    .then(payload => validateRequest(req, 'createUsageConsumptionReportRequest', payload))
    .then(payload => traverse(req, requestSchema, payload,[],getPayloadType(req)))
    .then(payload => processCommonAttributes(req, resourceType, payload))
    .then(payload => processAssignmentRules('createUsageConsumptionReportRequest', payload))
    .then(payload => {
      ...
      mongoUtils.connect().then(db => {
        db.collection(resourceType)
          ...
          .catch((error) => {
            console.log("createUsageConsumptionReportRequest: error=" + error);
    ...
    .catch( error => {
      console.log("createUsageConsumptionReportRequest: error=" + error.toString());
      sendError(res, error);
    });
...
exports.deleteUsageConsumptionReportRequest = function(req, res, next) {
  /**
  ...
  console.log('deleteUsageConsumptionReportRequest :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
...
exports.listUsageConsumptionReportRequest = function(req, res, next) {
  /**
  ...
  console.log('listUsageConsumptionReportRequest :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listUsageConsumptionReportRequest: error=" + error);
        sendError(res, internalError);
      })
    })
    .catch(error => {
...
exports.retrieveUsageConsumptionReportRequest = function(req, res, next) {
  /**
  ...
  console.log('retrieveUsageConsumptionReportRequest :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrieveUsageConsumptionReportRequest: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
