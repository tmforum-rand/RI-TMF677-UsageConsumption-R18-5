...
exports.deleteUsageConsumptionReport = function(req, res, next) {
  /**
  ...
  console.log('deleteUsageConsumptionReport :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
...
exports.listUsageConsumptionReport = function(req, res, next) {
  /**
  ...
  console.log('listUsageConsumptionReport :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listUsageConsumptionReport: error=" + error);
...
exports.retrieveUsageConsumptionReport = function(req, res, next) {
  /**
  ...
  console.log('retrieveUsageConsumptionReport :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrieveUsageConsumptionReport: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
